...
1. （オプション）PRの説明ツールバーで**Copilot**アイコンと**Summary**アクションをクリックします。しばらくすると、Copilotがあなたの変更に基づいた説明を追加します。 :memo:
   ...
   <img alt="Copilot要約ボタン" width="450px" src="https://github.com/joshjones-jp/skills-getting-started-with-github-copilottest4/blob/main/.github/images/copilot-summarize-button.png?raw=true">
...
1. （オプション）右側の情報パネル上部にある**レビュアー**セクションを見つけ、**Copilotアイコン**の隣にある**リクエスト**ボタンをクリックします。Copilotがあなたのpull requestにレビューコメントを追加するまでしばらく待ちます！
   ...
   <img alt="Copilotレビューボタン" width="300px" src="https://github.com/joshjones-jp/skills-getting-started-with-github-copilottest4/blob/main/.github/images/copilot-review-button.png?raw=true">
